...
public class PizzaService {
   ...
   private final  PizzaRepository pizzaRepository;
    ...
    public Page<PizzaDTO> buscarTodos(Pageable  paginacao) {
        //aqui ele está trazendo para o cliente então traga em dto dps pega o fluxo e mapea e transforma em dto para mostrar para o usuario
        return pizzaRepository.findAll(paginacao)
